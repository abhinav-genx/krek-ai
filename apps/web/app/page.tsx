...
function PageContent() {
  ...
  const [active_chat_id, set_active_chat_id] = useState<string | null>(null);
  ...
  const onUserSubmit = async (e?: React.FormEvent) => {
    ...
    try {
      ...
      if (newChatId && newChatId !== active_chat_id) {
        // New chat -> open its live view.
        set_active_chat_id(newChatId);
      } else {
  ...
  return (
    <div className="flex w-screen h-screen">
      <ChatSidebar
        ...
        onNewChat={onNewChat}
        onSelectChat={(id) => set_active_chat_id(id)}
